...
class FirebaseChanelRepository {
  ...
  Future<void> actualizarMensaje(MesajeModel mensaje, String idCanal) =>firebaseChanelApi.actualizarMensaje(mensaje, idCanal);
  Future<DataSnapshot> recuperarMensajesChat( String idCanal) => firebaseChanelApi.recuperarMensajesChat(idCanal);
    
  Future<void> detenerSuscripcion() =>firebaseChanelApi.detenerSuscripcion();
  ...
  void initOyente2(String idCanal)=> firebaseChanelApi.initOyente2(idCanal);
